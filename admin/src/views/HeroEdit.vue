        ...
        <el-tabs value="skills" type="border-card">
          ...
          <el-tab-pane label = "基本信息">
            ...
            <el-form-item label="名称">
              <el-input v-model="model.name" placeholder="请输入新建英雄的名称"></el-input>
            </el-form-item>
            ...
            <el-form-item label="称号">
              <el-input v-model="model.title" placeholder="请输入新建英雄的名称"></el-input>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    async fetch() {
      ...
      // res.data与model中同时存在的字段，会被res.data中的值所替换，res.data中没有的字段，不会改变model中的数据
